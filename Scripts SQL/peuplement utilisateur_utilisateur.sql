...
INSERT INTO `utilisateur_utilisateur` (`utilisateur_email`,`contact_email`) VALUES ('un@test.com','movom@yahoo.fr');
INSERT INTO `utilisateur_utilisateur` (`utilisateur_email`,`contact_email`) VALUES ('un@test.com','quatre@test.com');
